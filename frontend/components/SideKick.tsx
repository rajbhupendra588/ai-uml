...
export function SideKick({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "shrink-0 border-l border-[var(--border)] bg-[var(--card)] transition-all duration-200 ease-out flex flex-col",
          // Mobile: fixed overlay that slides in from right
          "fixed md:relative inset-y-0 right-0 z-50 md:z-auto",
          isOpen
            ? "w-full sm:w-96 md:w-96 max-w-[min(24rem,100vw)] translate-x-0"
